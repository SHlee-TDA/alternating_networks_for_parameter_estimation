...
$\varepsilon_H,\varepsilon_P$ and Lemma~\ref{lem:condlip}. One expects, accordingly, a bound
$\varepsilon_{\mathrm{inc}}\le C\,(\varepsilon_H+\varepsilon_P)$ with $C$ depending on $\kappa,L_H,L_P$
(and the regularity of the true conditionals); we defer the precise constant to a later note. The
