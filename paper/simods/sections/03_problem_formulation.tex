...
We refer to this unobserved state as the \emph{hidden state} to emphasize its role as an essential latent feature that must be explicitly reconstructed to infer unknown parameter $\theta$.
...
recovery guarantees: Takens' embedding theorem and the Hermann--Krener observability rank condition
