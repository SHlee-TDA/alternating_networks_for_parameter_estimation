...
def calibrate_noise():
    ...
    calibrated_data = {
        ...
        # Sigma (Standard Deviation) - Diffusion Term용
        'sigma_G': sigma_emp_G_t,
        'sigma_I': sigma_emp_I_t,
        # Mu (Mean Bias) - Potential Drift Correction용
        'mu_G': mu_emp_G_t,
        'mu_I': mu_emp_I_t,
        'bounds': {
            'G_max': UPPER_BOUND_G,
    ...
    print("Calibrated data saved to 'calibrated_sigmas.json'")
